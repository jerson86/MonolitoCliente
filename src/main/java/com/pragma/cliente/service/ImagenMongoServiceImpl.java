...
public class ImagenMongoServiceImpl implements ImagenMongoService{
    ...
    @Override
    public ResponseEntity<ImagenMongoDTO> createImagen(MultipartFile foto, Long idCliente){
    ...
    @Override
    public ResponseEntity<ImagenMongoDTO> updateImagen(String id, MultipartFile foto, Long idCliente) {
    ...
    @Override
    public ResponseEntity<ImagenMongoDTO> deleteImagen(String id) {
        ImagenMongo imagen = imagenRepository.findById(id).orElseThrow(()-> new ResourceNotFoundException("imagen",Long.parseLong(id)));
    ...
    @Override
    public ResponseEntity<ImagenMongoDTO> getImagenById(String id) {
        ImagenMongo imagen = imagenRepository.findById(id).orElseThrow(()-> new ResourceNotFoundException("imagen",Long.parseLong(id)));
    ...
    @Override
    public ResponseEntity<ImagenMongoDTO> getImagenByCliente(ClienteDTO clienteDTO) {
